...
RELEASES = [
    ...
    },
    {
        ...
        "items": [
            ("output_test", "v1 内置音色", "workspace/_archive_v3.0.0/output_test/output/output_test_dubbed.mp4"),
            ("output_test", "v2 原声音色", "workspace/_archive_v3.0.0/output_test/output/v2_cloned_dubbed.mp4"),
            ("test_1", "v1 内置音色", "workspace/_archive_v3.0.0/test_1/output/test_1_dubbed.mp4"),
            ("test_1", "v2 原声音色", "workspace/_archive_v3.0.0/test_1/output/v2_cloned_dubbed.mp4"),
            ("test_2", "v1 内置音色", "workspace/_archive_v3.0.0/test_2/output/test_2_dubbed.mp4"),
            ("test_2", "v2 原声音色", "workspace/_archive_v3.0.0/test_2/output/v2_cloned_dubbed.mp4"),
        ],
        "demos": [
            ("output_test", "workspace/_archive_v3.0.0/output_test/deliver/output_test_dubbed"),
            ("test_1", "workspace/_archive_v3.0.0/test_1/deliver/test_1_dubbed"),
            ("test_2", "workspace/_archive_v3.0.0/test_2/deliver/test_2_dubbed"),
        ],
    },
    {
        "id": "v2.0.0",
